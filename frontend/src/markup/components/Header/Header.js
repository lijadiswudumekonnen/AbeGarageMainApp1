          ...
          <div class="auto-container">
            <div class="inner-container">
              ...
              <div class="right-column">
                {isLogged ? (
                  <div class="link-btn">
                    <div className="phone-number"><strong>Welcome Abe {employee?.employee_first_name}</strong></div>
                  </div>
                ) : (
                  <div className="phone-number"> schedule Appointment: <strong>1800 456 7890</strong>
                  </div>
                )}
                  {/* <div class="link-btn">
            ...
            <div class="inner-container">
              ...
              <div class="right-column">
                ...
                {isLogged ? (
                 ...
                 <div class="link-btn">
                  <Link to="/" className="theme-btn btn-style-one blue" 
